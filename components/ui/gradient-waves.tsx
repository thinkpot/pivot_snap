...
// Defaults tuned to PivotSnap's dark/bull-green palette so the hero
// background blends into the page without any props at the call site.
export function GradientWaves({
  ...
  useEffect(() => {
    ...
    // The page can host many WebGL canvases (this background plus every
    // SpecularButton); once the browser's per-page context budget (~16) is
    // exhausted, ogl's Renderer throws while attaching itself to a null gl
    // context. Degrade to no background instead of crashing the page.
